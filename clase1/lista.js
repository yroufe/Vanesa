let listaProductos = [{
  ...
  listaProductos.forEach (producto => {
    ...
    agregarHTML.innerHTML = `
     ...
     <h6>Descripcion: ${producto.description}</h6>
     <p>Precio: $${producto.price}</p>
    `;

    contenedor.appendChild(agregarHTML);
  });

// 1 - le pidas al usuario datos y agregue producto nuevo al array
// 2 - que ese producto nuevo se vea en el html
// 3 - agregues algunos estilos